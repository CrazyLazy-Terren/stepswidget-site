---
slug: track-steps-iphone-without-apple-watch
category: Widgets
title: How to Track Steps on iPhone Without an Apple Watch
metaTitle: Track Steps on iPhone Without Apple Watch | Steps Widget
description: Learn how to track steps on your iPhone without an Apple Watch using built-in sensors, Apple Health, and a private steps widget for your Home and Lock Screens.
date: 2026-07-02
readingTime: 5 min read
keywords:
  - track steps on iphone without apple watch
  - step counter iphone without watch
  - how to count steps on iphone
  - steps widget without apple watch
  - iphone step counter widget
  - apple health steps widget
  - step tracker no apple watch
image: /assets/blog-track-no-watch.jpg
---

You do not need to wear an Apple Watch or carry a separate fitness band to track your daily steps. Your iPhone is already capable of counting steps on its own.
...
Every iPhone since the iPhone 5s contains specialized hardware, including an accelerometer and a dedicated motion coprocessor, that detects movement. When you walk, run, or climb stairs with your iPhone in your pocket, bag, or hand, it automatically counts your steps, along with walking distance and flights of stairs climbed.
...
- Return to your Home Screen, touch and hold the background, tap Edit in the top corner, then tap Add Widget.
- Search for Steps Widget, select your preferred size, and tap Add Widget.
- For the Lock Screen, touch and hold the Lock Screen, tap Customize, and add Steps Widget to the widget slot below the clock.
