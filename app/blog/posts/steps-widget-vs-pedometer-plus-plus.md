...
- **Route planning and hiking.** Import GPX files, build your own routes, see elevation changes, and download offline map data for areas without cell service.
- **Workout tracking** on both iPhone and Apple Watch, written back to Apple Health.
- **Expedition Mode**, which extends Apple Watch battery life on long walks by reducing heart-rate polling. Their testing reports up to 40 percent improvement.
...
- You want workout tracking on your iPhone or Apple Watch.
- You need wheelchair push counting.
...
If you have read this far and your honest answer to *"what is actually wrong with my day"* is that nothing reminds you to get up, that is the gap Steps Widget was built for. If your answer is that you want to track your walking properly, Pedometer++ is the better app and you should use it.
