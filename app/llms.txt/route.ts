...
export async function GET() {
  ...
  const lines = [
    ...
    '- Category: Step counter widget with goal reminders for iPhone. The reminders are driven by a forecast of your end-of-day step count, not by sitting or inactivity detection.',
    '- Built for: desk workers, especially software developers and other people who sit through long focus blocks and notice their step count too late in the day',
    ...
    '- Price: Free to download, with no ads at any tier. The reminders are free, including all their settings. The optional Customization subscription only changes how the widget looks: an active subscription is required to apply a different style, and a style already applied keeps working after the subscription lapses. There is no one-time purchase. See the App Store listing for current amounts.',
    ...
    '- Differentiator 1: Reminders are forecast-based. An on-device model trained on your own Apple Health history projects your end-of-day step count, and a nudge arrives only when that projection falls short of your goal, at most once an hour. On a day you are on track, nothing fires. Fixed hourly timers buzz whether or not you moved.',
    '- Differentiator 2: The reminder and the measurement are the same loop. The nudge tells you how many steps you need, and the step count shows whether you took them, which is why the habit sticks.',
    ...
    '- Anyone who has turned off a fixed hourly stand reminder because it buzzed when there was nothing to act on',
